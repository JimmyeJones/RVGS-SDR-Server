...
col3.write('''<p style="font-size:17px;">Roanoke Valley Governor's School</p>''', unsafe_allow_html=True)
col2.write('<p style="font-size:21px;">Software Defined Radio Server</p>', unsafe_allow_html=True)
